...
\begin{frame}
  ...
  \begin{columns}
    ...
    \begin{figure}
        \begin{center}
            \href{https://iris-hep.org/fellows/Saransh-cpp.html}{\includegraphics[width=0.8\linewidth]{vector-fellow-project.pdf}}
        \end{center}
        \linkref{https://iris-hep.org/fellows/Saransh-cpp.html}{Saransh Chopra}
    \end{figure}
%
    \column[t]{0.50\textwidth}
    \vspace{10pt}
    \begin{figure}
        ...
        \end{center}
        \linkref{https://iris-hep.org/fellows/peterridolfi.html}{Peter Ridolfi}
    \end{figure}
  \end{columns}
