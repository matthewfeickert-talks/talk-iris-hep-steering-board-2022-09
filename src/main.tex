...
\begin{frame}
  ...
  \begin{figure}
    \begin{center}
      \includegraphics[width=0.6\linewidth]{AS-focus-area.png}
    \end{center}
  \end{figure}
...
\begin{frame}
  ...
  \begin{itemize}\setlength{\itemsep}{0.25 cm}
    \item Year 3 \linkref{https://indico.cern.ch/event/894515/contributions/3772800/}{focused on \textbf{Integration and Adoption}}
    \begin{itemize}
...
%
    ...
    \begin{figure}
        \begin{center}
            \href{https://jupyterlite.readthedocs.io/en/latest/_static/lab/index.html}{\includegraphics[width=\linewidth]{pyodide-hist.png}}
...
\begin{frame}
  ...
  %   \item Invitations from Scientific Python to get more involved in broader community
  % \end{itemize}
  \begin{columns}
    \column[t]{0.50\textwidth}
    \begin{itemize}
